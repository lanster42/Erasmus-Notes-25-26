...
\begin{enumerate}[label= (\alph*)]
 ...
 \item \includegraphics[scale=0.11]{2ex_a.jpeg}
 \item \includegraphics[scale=0.115]{2ex_b.jpeg}
 
 I might have made a mistake along the way but I did not get the same result as in (a). I have made sure that if Bob tries to verify the message he would get $H' = 10$ and not $H = 240$ which he was supposed to. The reason for the disconnect could be hashing since $H(x * y) \neq H(x) * H(y)$ in general.
